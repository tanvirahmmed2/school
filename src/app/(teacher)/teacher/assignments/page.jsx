...
export default function TeacherAssignmentsDisabledPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] p-6 text-center space-y-4">
      ...
      <p className="text-xs text-slate-500 max-w-sm">
        The assignments module has been deactivated. Please use Study Plans and Study Materials for subject resources.
      </p>
