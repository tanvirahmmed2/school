...
import { FiLock, FiMail, FiArrowRight, FiSliders, FiHome } from 'react-icons/fi';
        ...
        <div className="w-full bg-white border border-slate-100 rounded-3xl p-8 shadow-[0_10px_40px_rgba(0,0,0,0.03)]">
          <form onSubmit={handleSubmit} className="w-full flex flex-col gap-5">
            ...
            <div className="text-center text-xs font-semibold text-slate-400 mt-2">
              ...
              <Link href="/auth/access/staff/register" className="text-sky-600 hover:text-sky-700 transition-colors underline">
