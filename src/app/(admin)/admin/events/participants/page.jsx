          ...
          <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-xs flex flex-col sm:flex-row gap-5 items-start sm:items-center">
            {selectedEvent.image && (
              <div className="w-full sm:w-36 h-24 rounded-xl overflow-hidden shrink-0 bg-slate-100">
                <Image width={500} height={500} src={selectedEvent.image} alt={selectedEvent.title} className="w-full h-full object-cover" />
              </div>
            )}
...
const AdminEventParticipantsOverviewPage = () => {
  return (
...
export default AdminEventParticipantsOverviewPage;
