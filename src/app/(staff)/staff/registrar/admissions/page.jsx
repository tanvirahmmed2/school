                  ...
                  {pendingAdmissions.map((adm) => (
                    <tr key={adm.id} className="hover:bg-slate-50/30 transition-colors">
                      <td className="px-6 py-4">
                        <div>
                          <p className="text-sm font-bold text-slate-900">{adm.applicant_name}</p>
                      ...
                      <td className="px-6 py-4">
                        <div>
                          ...
                          <p className="text-xs text-slate-450 text-slate-400 mt-0.5">{adm.email}</p>
                        </div>
                      </td>
                      <td className="px-6 py-4">
                        <div>
                ...
                {processedAdmissions.map((adm) => (
                  <tr key={adm.id} className="hover:bg-slate-50/30 transition-colors">
                    <td className="px-6 py-4">
                      <div>
                        <p className="text-sm font-bold text-slate-900">{adm.applicant_name}</p>
                        <p className="text-xs text-slate-450 text-slate-400 mt-0.5">{adm.email} | {adm.phone}</p>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                    ...
                    <td className="px-6 py-4 text-slate-500 font-medium">
                      {new Date(adm.updated_at).toLocaleDateString(undefined, {
                        year: 'numeric',
                        month: 'short',
                        day: 'numeric',
                      })}
